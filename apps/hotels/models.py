...
# def hotel_star_post_save(instance, sender, created, *args, **kwargs):
#     if created:
#         hotel_stars = HotelRank.objects.filter(hotel_id=instance.id)
#         a = 0
#         for i in hotel_stars:
#             a += i.stars

#         instance.stars =a/len(hotel_stars)
#         instance.save()

# post_save.connect(hotel_star_post_save, sender=Hotel)